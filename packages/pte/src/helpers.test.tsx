...
test('should find DOM node at offset', () => {
  const span1_0 = (
    <span data-text data-offset="1" data-chunk-offset="0" data-chunk-length="4">
      Test
    </span>
  )

  const span3_0 = (
    <span data-text data-offset="3" data-chunk-offset="0" data-chunk-length="3">
      Hel
    </span>
  )
  const span3_1 = (
    <span data-text data-offset="3" data-chunk-offset="3" data-chunk-length="9">
      lo, world
    </span>
  )
...
test('get and set dom selection', () => {
  const node = (
    <span data-offset="1" data-chunk-offset="16" data-chunk-length="12">
      in selection
    </span>
  )
